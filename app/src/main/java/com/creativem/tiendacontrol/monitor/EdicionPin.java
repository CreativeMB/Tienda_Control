...
public class EdicionPin extends AppCompatActivity {
    ...
    private static final String TAG = "EdicionPin"; // Etiqueta para los mensajes de log
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guardaPin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!code.isEmpty()) {
                    ...
                    Toast.makeText(EdicionPin.this, "Código guardado correctamente", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(EdicionPin.this, Inicio.class);
                    startActivity(intent);
                    finish(); // Cierra la actividad actual
                } else {
                    Toast.makeText(EdicionPin.this, "El campo de código está vacío", Toast.LENGTH_SHORT).show();
        ...
        textViewDeleteCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EdicionPin.this, "Código eliminado", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "Código eliminado"); // Mensaje de log para depuración

                // Redirige a la actividad BaseDatos después de eliminar el código
                Intent intent = new Intent(EdicionPin.this, BaseDatos.class);
                startActivity(intent);
                finish(); // Cierra la actividad actual
            }
        });
