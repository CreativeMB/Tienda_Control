...
import static com.example.tiendacontrol.monitor.MainActivity.REQUEST_CODE_PERFIL_USUARIO;
...
public class MenuAdapter extends Fragment {
        ...
        requestStoragePermissionLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result.containsValue(false)) {
                        // Permiso denegado
                        Toast.makeText(requireContext(), "Permiso de escritura en almacenamiento externo denegado",
    ...
    public void dirigirAInicioSesion() {
